...
import com.hackdf.autochilango.adapters.AdapterOffenses;
...
public class FragmentOffensesList extends Fragment {

	public static FragmentOffensesList newInstance(String title) {
		FragmentOffensesList f = new FragmentOffensesList();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		try {
			...
			if (carInfo != null) {
				...
				ArrayList<Offenses> offenses= carInfo.getOffenseList();
				if (offenses != null) {
					AdapterOffenses adapter = new AdapterOffenses(
							getActivity(),offenses);
